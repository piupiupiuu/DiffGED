...
from layers import AttentionModule, TensorNetworkModule, MatchingModule
...
class GPN(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        tmp_feature_1 = abstract_features_1.clone()
        tmp_feature_2 = abstract_features_2.clone()
        abstract_features_1 = torch.sub(tmp_feature_1, self.matching_2(tmp_feature_2,graph_batch_2)[graph_batch_1])
        abstract_features_2 = torch.sub(tmp_feature_2, self.matching_1(tmp_feature_1,graph_batch_1)[graph_batch_2])
